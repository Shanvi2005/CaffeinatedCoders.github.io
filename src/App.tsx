...
function App() {
  ...
  useEffect(() => {
    ...
    switch (pathname) {
      ...
      case "/myntra-studio-edit":
        ...
        metaDescription = "";
        break;
      case "/wwwmyntracom-by-htmltodesign-free-version-11072024-162506-gmt530":
        title = "";
        metaDescription = "";
        break;
      case "/explore":
  ...
  return (
    <Routes>
      <Route path="/" element={<YourPostHOMEPAGEEDIT />} />
      ...
      <Route
        path="/wwwmyntracom-by-htmltodesign-free-version-11072024-162506-gmt530"
        element={<WwwmyntracomByHtmltodesi />}
      />
